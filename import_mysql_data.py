...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://library_user:library_pass@localhost:3306/library_db'
...
def import_books_from_mysql(csv_file='books_dataset.csv'):
    """Import books from CSV file into MySQL database"""
    ...
    with app.app_context():
        ...
        # Commit all changes
        db.session.commit()
        print(f"Successfully imported {books_imported} books into MySQL database!")
...
if __name__ == '__main__':
    ...
    print("⚠️  Make sure MySQL is running on localhost:3306")
    print("   Database: library_db")
    print("   User: library_user")
    print("   Password: library_pass")
    print("")
